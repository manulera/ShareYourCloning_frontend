describe('RepositoryId Source', () => {
  ...
  it('works for reference genome', () => {
    ...
    cy.get('#\\:rv\\:').should('have.value', 'GCF_000002945.1');
    ...
    cy.get(':nth-child(2) > :nth-child(1) > a').should('have.attr', 'href', 'https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_000002945.1');
    cy.get(':nth-child(2) > a').should('have.attr', 'href', 'https://www.ncbi.nlm.nih.gov/nuccore/NC_003424.3');
    cy.get(':nth-child(4) > a').should('have.attr', 'href', 'https://www.ncbi.nlm.nih.gov/gene/2543372');
