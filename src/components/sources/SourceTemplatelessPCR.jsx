...
//TODO: This is a copy of SourcePCR.jsx, adapt according to TemplatelessPCR function
...
function SourceTemplatelessPCR({ sourceId }) {
  ...
  const onSubmit = (event) => {
    ...
    const requestData = {
      ...
      source: { forward_primer: forwardPrimerId, reverse_primer: reversePrimerId },
    };
  ...
  return (
    <div className="restriction"> {/* Is this className correct? Same problem for most sources*/}
      <form onSubmit={onSubmit}>
        ...
        <SubmitButtonBackendAPI requestStatus={requestStatus}>Perform Templateless PCR</SubmitButtonBackendAPI>
      </form>
...
export default SourceTemplatelessPCR;
