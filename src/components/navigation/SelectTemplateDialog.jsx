...
function SelectTemplateDialog({ onClose, open }) {
  ...
  const baseUrl = 'https://raw.githubusercontent.com/genestorian/OpenCloning-submission/master';
      ...
      <List>
        ...
        <ListItem key="blah" className="load-template-item">
          ...
          <IconButton edge="end" aria-label="submit-button">
            <Button className="button-hyperlink" variant="contained" color="success" href="https://github.com/genestorian/OpenCloning-submission/blob/master/docs/index.md" target="_blank" rel="noopener noreferrer">Create templates</Button>
          </IconButton>
